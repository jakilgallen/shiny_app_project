  ...
  tabItems(
    tabItem(tabName = "home",
            fluidPage(
              ...
              box(title = "World Map of Gender Equality Indicators",
                  ...
                  h3("Key of Indicators"),
                  h4("Gender Equality Index:"),
                  p("This represents a summary score of how gender egalitarian each country is, this index is formulated by combining all of the indicators discussed here into one value from 0-1.
                    Values closer to 0 indicate a more gender egalitarian country, while closer to 0 a more gender inequal country"),
                  h4("Maternal Mortality Ratio:"),
                  p("This is the deaths per 100,000 live births"),
                  h4("Adolescent birth Rate:"),
                  p("This is the births per 1,000 women ages 15- 19 years old"),
                  h4("Seats in Parliament:"),
                  p("Shows the % of seats held by women"),
                  h4("Female Labour Force Participation:"),
                  p("Shows the % of females ages 15 and older who are a part of the labour force"),
                  h4("Female Secondary Education:"),
                  p("Shows the % of women who have achieved at least secondary education (i.e. completed highschool)")),
    ...
    tabItem(tabName = "involved",
              box(title = "Get Informed",
                  ...
                  tags$a(href = "https://nypost.com/2022/03/15/un-says-women-pay-highest-price-in-conflict-now-in-ukraine/", "UN says women pay highest price in conflict, now in Ukraine"),
                  p(" "),
                  tags$a(href = "https://xyonline.net/content", "Men's Role in Gender Equality"),
                  p(" "),
                  h1("Research on Gender Equality"),
                  tags$a(href = "https://news.un.org/en/story/2022/03/1113952", "UN on ‘positive trajectory’ towards full gender parity "),
                  p(" "),
                  tags$a(href = "https://www.cambridge.org/core/journals/evolutionary-human-sciences/article/he-for-she-variation-and-exaggeration-in-mens-support-for-womens-empowerment-in-northern-tanzania/36A7D3C8FFBD3117316DA112C663CE35#ref38"
                         , "Recent Research from UCSB on Variation in Men's Support for Gender Equality and Women's Empowerment"),
                  p(" "),
                  tags$a(href = "https://pubmed.ncbi.nlm.nih.gov/32744473/", "Impact Evaluation of MAISHA Intervention Tanzania"),
                  p(" ")),
              box(title = "Get Involved",
                  ...
                  p(" "),
                  tags$a(href = "http://strive.lshtm.ac.uk/projects/maisha-microfinance-and-gender-training-reduce-violence-against-women", 
                         "MAISHA: Microfinance and Gender Training"),
                  p(" "),
